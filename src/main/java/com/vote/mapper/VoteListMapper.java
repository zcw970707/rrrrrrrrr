...
public interface VoteListMapper {
    List<Map<String,Object>> findAll(String vs_title);//展示页方法，标题，投票数，选项数
    List<Map<String,Object>>findById(Integer id);//投票详情
    List<VoteOption> joinVote(int id);
    List<Map<String,Object>>  usersVote(@Param("vu_user_id") int vu_user_id,@Param("vs_id")int vs_id);//一个用户一个主题只能投一次票
